...
public class CondenserTile extends BlockEntity {
//    public int liquidLevel = 0;
    public CondenserTile(BlockPos p_155229_, BlockState p_155230_) {
        super(BreakBadTiles.CONDENSER_TILE.get(), p_155229_, p_155230_);
    }
